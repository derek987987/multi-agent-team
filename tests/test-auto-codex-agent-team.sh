...
assert_file_exists "scripts/recover-stale-routes.sh"
assert_file_exists "scripts/detect-agent-health.sh"
assert_file_exists "scripts/checkpoint-agent-context.sh"
assert_file_exists "scripts/recover-agent-session.sh"
assert_file_exists "scripts/monitor-agent-sessions.sh"
assert_file_exists "scripts/repair-role-readiness.sh"
...
assert_executable "scripts/recover-stale-routes.sh"
assert_executable "scripts/detect-agent-health.sh"
assert_executable "scripts/checkpoint-agent-context.sh"
assert_executable "scripts/recover-agent-session.sh"
assert_executable "scripts/monitor-agent-sessions.sh"
assert_executable "scripts/repair-role-readiness.sh"
...
assert_contains "$(cat "$ROOT/scripts/watch-routes.sh")" "recover-stale-routes.sh" "watcher stale recovery"
assert_contains "$(cat "$ROOT/scripts/watch-routes.sh")" "AGENT_TEAM_AUTO_RECOVER_STALE" "watcher stale recovery"
assert_contains "$(cat "$ROOT/scripts/watch-routes.sh")" "monitor-agent-sessions.sh" "watcher agent recovery"
