...
required_files=(
  ...
  "scripts/record-final-human-decision.sh"
  ...
  "scripts/promote-final-review-routes.sh"
...
bash -n "$ROOT/scripts/record-final-human-decision.sh"
...
bash -n "$ROOT/scripts/promote-final-review-routes.sh"
bash -n "$ROOT/scripts/check-project-completion-notification.sh"
...
bash "$ROOT/tests/test-project-completion-notification.sh"
