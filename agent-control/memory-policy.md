...
- Role memory should stay role-specific. Shared conventions belong in `AGENTS.md` or `agent-control/sop.md`.
- Meeting outcomes that affect future execution should first be recorded in `agent-control/meetings/` and only promoted into role memory when they are durable lessons or preferences.
